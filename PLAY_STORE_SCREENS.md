...
| | |
|--|--|
| **Enter** | `Snooker League` |
| **Limit** | 30 characters (14/30 is fine) |
...
1. Stay on this app (title **Snooker League** in the top bar).
...
```text
Privacy Policy — Snooker League

Snooker League (“the App”) is provided for tracking snooker league matches and races.

Data we collect
• Google account info used for sign-in (name, email, photo if provided by Google)
• League data you create: league name, players, matches, races, scores, and related activity

How we use data
• To authenticate you (Google Sign-In)
• To sync your league data across devices via Firebase (Authentication and Cloud Firestore)
...
| Question | Answer for Snooker League |
|----------|---------------------------|
...
| App activity / gameplay | Yes | Matches, races, scores |
...
Answer **No** unless they clearly apply. Snooker League is not a bank/health/government app.
...
| Field | Enter exactly |
|-------|----------------|
| **App name** | `Snooker League` |
| **Short description** | `Track doubles matches, races, and league champions.` |
| **Full description** | Paste block below |

**Full description:**

```text
Snooker League helps your club track doubles matches and race-to-score games on your phone.

• Log doubles matches and individual races
• See leaderboards, form, and champions
...
| **Feature graphic** | 1024 × 500 | Banner with text “Snooker League” on dark green `#071A10` |
...
App name should still be **Snooker League**.
...
```text
First public release of Snooker League — track doubles, races, and champions.
```
